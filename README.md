...
***I would like to make it clear that the following specification is taken from the lab instructon written by Professor Allan Gottlieb, distributed to our OS class by Professor Yan Shvartzshnaider. I have made some edits, but the writing is Professor Gottlieb's. Please refer to the <a ref="https://github.com/gayeon97/Operating-Systems-Lab-04/blob/main/Demand_Paging_original_instructions.pdf" target="_blank">linked file</a> for the actual lab instruction.***
